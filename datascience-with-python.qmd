...
### Persistence: Referring to Values in Memory
...
mean_revenue = (12000 * 23000 * 15000 * 10000 * 18000) ** 0.2
```

In this example, we calculate the geometric mean of the revenues and store it in a variable called `mean_revenue`. The variable name should be descriptive, helping you understand its purpose and content.
